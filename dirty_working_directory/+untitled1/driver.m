...
M_.block_structure.block(2).equation = [ 1 4 2 3];
M_.block_structure.block(2).variable = [ 5 3 2 1];
...
M_.block_structure.block(2).g1_sparse_rowval = int32([2 4 1 4 2 3 1 2 3 1 2 4 3 3 ]);
...
M_.block_structure.variable_reordered = [ 4 6 5 3 2 1];
M_.block_structure.equation_reordered = [ 5 6 1 4 2 3];
...
M_.block_structure_stat.block(2).variable = [ 1 3 5 2];
M_.block_structure_stat.variable_reordered = [ 6 4 1 3 5 2];
...
M_.block_structure_stat.block(2).g1_sparse_rowval = int32([1 2 3 4 2 3 4 1 3 1 4 ]);
M_.block_structure_stat.block(2).g1_sparse_colval = int32([1 1 1 1 2 2 2 3 3 4 4 ]);
M_.block_structure_stat.block(2).g1_sparse_colptr = int32([1 5 8 10 12 ]);
...
save([M_.dname filesep 'Output' filesep 'untitled1_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled1_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled1_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled1_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled1_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled1_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled1_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled1_results.mat'], 'options_mom_', '-append');
end
